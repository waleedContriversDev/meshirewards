        ...
        <div className="flex flex-col border rounded-lg border-slate-300 py-2 mt-2">
            ...
            <div className="py-2 px-3">
                ...
                <div className="flex justify-between mt-3">
                    <button className="text-white bg-sky-600 rounded-lg text-xs px-4 py-2">SPOIL <br /> YOURSELF</button>
                    <button className="text-white bg-sky-600 rounded-lg text-xs px-4 py-2">SPOIL <br /> OTHERS</button>
                </div>
            </div>
        </div>
    );
